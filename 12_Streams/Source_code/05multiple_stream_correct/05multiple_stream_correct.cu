...
void onHost(){
    ...
    HANDLER_ERROR_ERR( cudaHostAlloc((void**)&h_a.elements, FULL_ARRAY_BYTES, cudaHostAllocDefault ));
    HANDLER_ERROR_ERR( cudaHostAlloc((void**)&h_b.elements, FULL_ARRAY_BYTES, cudaHostAllocDefault ));
